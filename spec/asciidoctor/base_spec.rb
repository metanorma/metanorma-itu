...
<version>
  ...
  <series type="main">
  <title type="full">A: The series title</title>
...
OUTPUT
      ...
      it "processes explicit metadata, recommendation supplement" do
  ...
  <bibitem type='standard'>
    <fetched>2021-01-22</fetched>
    <title type='title-intro' format='text/plain' language='en' script='Latn'>Specification and Description Language</title>
    <title type='title-main' format='text/plain' language='en' script='Latn'>Overview of SDL-2010</title>
    <title type='main' format='text/plain' language='en' script='Latn'>Specification and Description Language — Overview of SDL-2010</title>
    <uri type='src'>https://www.itu.int/ITU-T/recommendations/rec.aspx?rec=14048&amp;lang=en</uri>
    <uri type='obp'>https://www.itu.inthttp//handle.itu.int/11.1002/1000/14048-en?locatt=format:pdf&amp;auth</uri>
    ...
    <relation type='complements'>
      <bibitem type='standard'>
        <formattedref format='text/plain' language='en' script='Latn'>Z Suppl. 1 (04/2015)</formattedref>
      </bibitem>
    </relation>
    <relation type='instance'>
      <bibitem type='standard'>
        ...
        <language>en</language>
        <script>Latn</script>
        <abstract format='text/plain' language='en' script='Latn'>This annex defines the SDL‑2010 dynamic semantics.</abstract>
        <status>
          <stage>Published</stage>
        </status>
        <copyright>
