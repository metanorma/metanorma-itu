      ...
      <div id="A0">
        ...
        <tbody/>
                     ...
                     <div id="L" class="Symbols">
                        <h1>4<span class="fmt-clause-delim">.</span>  Abréviations et acronymes</h1>
  ...
  it "processes section names in Chinese" do
    presxml = <<~OUTPUT
       <metanorma xmlns="http://riboseinc.com/isoxml" type="presentation">
          ...
          <preface>
             <clause type="toc" id="_" displayorder="1">
                <fmt-title depth="1" id="_">目　录</fmt-title>
             </clause>
             <abstract id="_" displayorder="2">
                <title id="_">Abstract</title>
                <fmt-title depth="1" id="_">
             ...
             <clause id="_" type="keyword" displayorder="3">
                <fmt-title id="_" depth="1">关　键　词</fmt-title>
                <p>A，B.</p>
             </clause>
             <foreword obligation="informative" id="_" displayorder="4">
                <title id="_">Foreword</title>
          ...
          <sections>
             <p class="zzSTDTitle1" displayorder="7">建议书
         12345</p>
    ...
    html = <<~OUTPUT
      #{HTML_HDR.sub('Table of Contents', '目　录')}
         ...
         12345</p>
             ...
             <div id="I">
                ...
                <div id="J">
                   <p class="TermNum" id="J">
                      <b>
                         3.1<span class="fmt-clause-delim">.</span>　
                         <b><dfn>Term2</dfn></b>
                         ：
                      </b>
                   </p>
             ...
             <div id="L" class="Symbols">
                <h1>4<span class="fmt-clause-delim">.</span>　缩略语与缩写</h1>
                <table class="dl" style="table-layout:fixed;">
                   <colgroup>
                      <col style="width: 20%;"/>
                      <col style="width: 80%;"/>
